...
cn_preprocessor_modules = {
    ...
    "openpose": functools.partial(g_openpose_model.run_model, include_body=True),
    "openpose_hand": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=True),
    "openpose_face": functools.partial(g_openpose_model.run_model, include_body=True, include_face=True),
    "openpose_faceonly": functools.partial(g_openpose_model.run_model, include_body=False, include_face=True),
