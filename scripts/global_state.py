...
cn_preprocessor_modules = {
    ...
    "revision_moore": functools.partial(clip, config='clip_vith'),
    "revision_moore_ignore_prompt": functools.partial(clip, config='clip_vith'),
    ...
    "reference_magic_animate": identity,
    "reference_moore_animate_anyone": identity,
    "inpaint": identity,
...
cn_preprocessor_unloadable = {
    ...
    "revision_moore": functools.partial(unload_clip, config='clip_vith'),
    "revision_moore_ignore_prompt": functools.partial(unload_clip, config='clip_vith'),
