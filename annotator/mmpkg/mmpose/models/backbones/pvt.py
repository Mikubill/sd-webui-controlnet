...
from annotator.mmpkg.mmcv.cnn import (Conv2d, build_activation_layer, build_norm_layer,
                      constant_init, normal_init, trunc_normal_init)
from annotator.mmpkg.mmcv.cnn.bricks.drop import build_dropout
from annotator.mmpkg.mmcv.cnn.bricks.transformer import MultiheadAttention
from annotator.mmpkg.mmcv.cnn.utils.weight_init import trunc_normal_
from annotator.mmpkg.mmcv.runner import (BaseModule, ModuleList, Sequential, _load_checkpoint,
                         load_state_dict)
...
class SpatialReductionAttention(MultiheadAttention):
    ...
    def __init__(self,
        ...
        from annotator.mmpkg.mmpose import digit_version, mmcv_version
