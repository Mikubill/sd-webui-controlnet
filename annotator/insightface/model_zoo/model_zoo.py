...
from ..storage import MODEL_DIR, download_onnx
...
def get_model(name, **kwargs):
    # root = kwargs.get('root', MODEL_DIR)
    ...
    if not osp.exists(model_file) and allow_download:
        model_file = download_onnx('models', model_file, root=MODEL_DIR, download_zip=download_zip)
